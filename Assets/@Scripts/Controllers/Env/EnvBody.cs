                ...
                case EEnvType.Tree:
                    {
                        ...
                        spr = tr.GetComponent<SpriteRenderer>();
                        spr.material = _matDefault;
                        sprite = Managers.Resource.Load<Sprite>(CString.Sprite(EString.Sprite_Shadow));
                        if (sprite != null)
                        {
                            tr.localPosition = tree.StumpPosition;
                            spr.sprite = sprite;
                ...
                case EEnvType.Rock:
                    {
                        ...
                        SpriteRenderer spr = tr.GetComponent<SpriteRenderer>();
                        spr.material = _matDefault;
                        Sprite sprite = Managers.Resource.Load<Sprite>(CString.Sprite(EString.Sprite_RockBodyFrame));
                       ...
                       _rockBodyDict[ERockBody.Rock] = new BodyContainer(tag: tag, owner: Owner, tr: tr, spr: spr,
                        ...
                        spr = tr.GetComponent<SpriteRenderer>();
                        spr.material = _matDefault;
                        sprite = Managers.Resource.Load<Sprite>(CString.Sprite(EString.Sprite_RockEmptyFrame));
                        if (sprite != null)
                            spr.sprite = sprite;
                        ...
                        if (string.IsNullOrEmpty(rock.OreLightColor) == false)
                        {
                            if (ColorUtility.TryParseHtmlString(rock.OreLightColor, out Color oreLightColor))
                            {
                                ...
                                sprite = Managers.Resource.Load<Sprite>(CString.Sprite(EString.Sprite_CircleLight));
                                if (sprite != null)
                                    spr.sprite = sprite;
                            }
                        }
                        ...
                        if (string.IsNullOrEmpty(rock.OreLightColor) == false)
                        {
                            ...
                            ParticleSystemRenderer pr = tr.GetComponent<ParticleSystemRenderer>();
                            pr.material = Managers.Resource.Load<Material>(CString.Material(EString.Mat_Glow));
                        }
                        else
