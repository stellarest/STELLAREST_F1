...
namespace STELLAREST_F1
{
    public class SpriteManager
    {
        ...
        private void SetSpritesSet(int dataID, Env env)
        {
            ...
            {
                case EEnvType.Tree:
                    SetBodySprites(Managers.Data.TreeSpriteDataDict[dataID], env.EnvBody);
                    break;

                case EEnvType.Rock:
                    SetBodySprites(Managers.Data.RockSpriteDataDict[dataID], env);
                    break;
            }
        }

        // --- Env: Tree Base
        private void SetBodySprites(TreeSpriteData treeSpriteData, EnvBody envBody)
        {
            // // --- Trunk
            // Transform tr = envBody.GetContainer(ETreeBody.Trunk).TR;
            // tr.localPosition = treeSpriteData.TrunkPosition;
            // SpriteRenderer spr = envBody.GetContainer(ETreeBody.Trunk).SPR;
            // Sprite sprite = Managers.Resource.Load<Sprite>(treeSpriteData.Trunk);
            // if (sprite != null)
            //     spr.sprite = sprite;

            // // --- Patch
            // tr = envBody.GetContainer(ETreeBody.Patch).TR;
            // tr.localPosition = treeSpriteData.PatchPosition;
            // spr =  envBody.GetContainer(ETreeBody.Patch).SPR;
            // sprite = Managers.Resource.Load<Sprite>(treeSpriteData.Patch);
            // if (sprite != null)
            //     spr.sprite = sprite;

            // // --- Stump
            // tr = envBody.GetContainer(ETreeBody.Stump).TR;
            // tr.localPosition = treeSpriteData.StumpPosition;
            // spr = envBody.GetContainer(ETreeBody.Stump).SPR;
            // sprite = Managers.Resource.Load<Sprite>(treeSpriteData.Stump);
            // if (sprite != null)
            //     spr.sprite = sprite;

            // // EndParticles
            // tr = envBody.GetContainer(ETreeBody.EndParticle).TR;
            ...
            // // Fruits
            // tr = envBody.GetContainer(ETreeBody.Fruits).TR;
            ...
            // spr = envBody.GetContainer(ETreeBody.Shadow).SPR;
            // sprite = Managers.Resource.Load<Sprite>(ReadOnly.Util.Shadow_SP);
            // if (sprite != null)
            //     spr.sprite = sprite;
        }

        private void SetBodySprites(RockSpriteData rockSpriteData, Env env)
        {
            // Transform tr = null;
            ...
            // Material rockMat = Managers.Resource.Load<Material>(ReadOnly.Materials.Mat_RockFragments);
        ...
        public void ChangeSpriteSet(int newDataID, BaseObject owner)
        {
            switch (owner.ObjectType)
            {
                case EObjectType.Hero:
                    ...
                    ChangeBodySprites(heroBody, heroNewSpriteData, EHeroBody.Head);
                    ChangeBodySprites(heroBody, heroNewSpriteData, EHeroBody.UpperBody);
                    ChangeBodySprites(heroBody, heroNewSpriteData, EHeroBody.LowerBody);
                    ChangeBodySprites(heroBody, heroNewSpriteData, EHeroBody.Weapon);
                    break;
            }
        }
        ...
        private void ChangeBodySprites(HeroBody heroBody, HeroSpriteData heroNewSpriteData, EHeroBody heroBodyParts)
        {
            // Sprite sprite = null;
            // SpriteRenderer spr = null;
