...
namespace STELLAREST_F1
{
    public class UIManager
    {
        ...
        public GameObject Root
        {
            get
            {
                GameObject root = GameObject.Find(CString.Object(EString.Obj_UIRoot));
                if (root == null)
                    root = new GameObject { name = CString.Object(EString.Obj_UIRoot) };
        ...
        public void ClosePopupUI(UI_Popup popup)
        {
            ...
            {
                Dev.LogWarning(obj: nameof(UIManager), method: nameof(ClosePopupUI), log: $"Input: \"{popup.name}\"");
                return;
            }
