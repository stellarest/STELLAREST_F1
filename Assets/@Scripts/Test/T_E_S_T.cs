...
/*
// ********** --- 같은 셀에서 셀 중앙으로 강제 이동했을때 잠깐 멍때리고 공격하는거 고쳐야함 **********
// --- 그리고 공격 애니메이션 동작 시작하고 방향을 갑자기 확 돌렸을 때, 이때 데미지를 주어야할지, 이전 방향같은거 받아놓고.
// --- 팔라딘 위에 일자로 세 마리의 몬스터가 있을 때 나는 왼쪽, 가운데를 타겟팅하고 싶어서 왼쪽 조이스틱을 살짝 움직였는데
// --- 계속 오른쪽 방향으로 고정되어서 공격하는거 고쳐야할듯. 
